...
Rectangle {
  ...
  ColumnLayout {
	...
	command: ["whoami"]
	running: true
	onExited: usernameText.text = stdout ? "@" + stdout.trim() : "@user"
      }
	...
	command: ["uptime", "-p"]
	running: true
	onExited: uptimeText.text = stdout ? stdout.trim() : "uptime unknown"
      }
      Timer {
	...
	ColumnLayout {
      ...
      CircularBar { id: cpuBar; barColor: "#f38ba8"; labelText: "CPU" }
      CircularBar { id: ramBar; barColor: "#a6e3a1"; labelText: "RAM" }
      CircularBar { id: diskBar; barColor: "#f9e2af"; labelText: "DISK" }
	...
	onExited: cpuBar.value = stdout ? parseFloat(stdout) : 0
      }
	...
	onExited: ramBar.value = stdout ? parseFloat(stdout) : 0
      }
	...
	onExited: diskBar.value = stdout ? parseFloat(stdout) : 0
      }
